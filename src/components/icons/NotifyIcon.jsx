...
function NotifyIcon(props) {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15 18C15 19.6569 13.6569 21 12 21C10.3431 21 9 19.6569 9 18" stroke="black" strokeWidth="2"
            ...
            <path
                ...
                stroke="black" strokeWidth="2" strokeLinecap="2" className="my-path"></path>
            <path
